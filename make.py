...
os.path.join('BulletCollision', 'Gimpact', 'btGImpactCollisionAlgorithm.h'),
...
def build():
  ...
  emcc_args += ['-s', 'TOTAL_MEMORY=%d' % (128*1024*1024)] # default 64MB. Compile with ALLOW_MEMORY_GROWTH if you want a growable heap (slower though).
